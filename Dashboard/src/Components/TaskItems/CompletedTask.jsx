...
const CompletedTask = () => {
  return (
    <div>
               <div className="max-w-6xl mx-auto p-6 rounded-2xl mt-5 bg-green-300">
      ...
      <div className='mt-2 '>
        <button className='bg-green-400 rounded-xl p-2 text-black font-bold cursor-pointer'>Completed</button>
      </div>
      </div>
    </div>
  )
